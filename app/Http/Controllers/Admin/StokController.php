...
{
    /** Catat pergerakan stok (masuk/keluar) dan sinkronkan stok produk. */
    public function store(Request $request, Produk $produk): RedirectResponse
    {
        ...
        if (! $masuk && $data['jumlah'] > $produk->stok) {
            return back()->with('success', 'Jumlah keluar melebihi stok saat ini.');
        }
    ...
    /** Hapus catatan stok dan kembalikan efeknya ke stok produk. */
